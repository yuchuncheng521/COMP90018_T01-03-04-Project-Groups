...
// Soft, neutral palette so user-generated photos/content stay the visual focus
// (per the project plan's UI Appeal section).
val KnotCream = Color(0xFFFEF9F6)
val KnotSand = Color(0xFFF0E7DA)
