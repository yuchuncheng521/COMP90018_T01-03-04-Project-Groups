...
object P2pLocalNotificationManager {
    ...
    fun showNearbyMemberNotification(
        ...
        if (!NotificationPreferences.isPushEnabled(context)) return
        ...
        NotificationManagerCompat.from(context)
            .notify(peerName.hashCode(), notification)
    }
    ...
    private fun createNotificationChannel(context: Context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Alerts when a member of one of your Knot groups is nearby"
            }
